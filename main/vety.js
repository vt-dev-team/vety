            ...
            mounted: function() {
                ...
                audioElement.addEventListener("timeupdate", () => {
                        ...
                        $('.vmenu .menuScroller').css({
                            ...
                            height: "15px"
                        }) $(".ui.dropdown.button").dropdown() $(_t.$refs[this.menu.chosenTab]).transition('fade up', '100ms') audioElement.addEventListener("play", () => {
                            _t.status = 1
                        }) audioElement.addEventListener("pause", () => {
                            _t.status = 0
                        }) setInterval(function() { _t.loadText = _t.usefulWords[Math.floor(Math.random() * _t.usefulWords.length)] }, 3000) _t.loadText = _t.usefulWords[Math.floor(Math.random() * 3)]
                    },
                    methods: {
                        ...
                        changeTab: function(d) {
                            ...
                            if (_t.menu.tabMenuItems[d].page != this.menu.chosenTab) {
                                $('.vmenu .menuScroller').css('top', `${d*40+12.5}px`)
